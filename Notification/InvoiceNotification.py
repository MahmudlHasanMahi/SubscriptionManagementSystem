...
class InvoiceNotification:
    def __init__(self,id,subject):
        from ManagementSystem.models import Invoice
        self.invoice = Invoice.objects.get(id=id)
    ...
    def get_html_context(self):
        ...
        for i in self.invoice.invoice_detail.all():
        ...
        return  {
            ...
            "subscription": {
                "id":self.invoice.pk,
                "created":self.invoice.created.date().strftime("%Y-%m-%d")
            },
            "plans":plans,
            "total":total
        }
    ...
    def send_invoice(self):
        template_path = os.path.dirname(os.path.abspath(__file__)) + "/html_templates/invoice_generated.html"   
